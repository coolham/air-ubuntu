...
docker run -it --name wj-airdrop-1 --cap-add=SYS_PTRACE --shm-size=1024m  -v ./proxy_config/config1:/config -e USER=aladdin  -e PASSWORD=aladdin123  -e GID=1001  -e UID=1001  -p 13022:22 -p 7902:5901 --privileged wj-airdrop
