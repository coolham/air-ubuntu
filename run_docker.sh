...
docker run -it -e PROXY_TYPE=socks5 -e PROXY_IP=156.226.117.77 -e PROXY_PORT=49262 -e PROXY_USER=uVPPsZE -e PROXY_PASSWORD=mc2EiC  -v ./air_01/google-chrome:/root/.config/google-chrome -p 7389:3389 -p 7022:22 -p 7901:5901 --name wj-airdrop_01 --security-opt seccomp=unconfined --memory=1024m --cpu-shares=2 wj-airdrop
